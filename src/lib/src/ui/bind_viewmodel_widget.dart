...
class BindViewModel<TViewModel extends ObservableObject> extends StatefulWidget {
...
class _BindViewModelState<TViewModel extends ObservableObject> extends State<BindViewModel<TViewModel>> {
...
/// )
/// ```
class BindViewModel2<TViewModel1 extends ObservableObject, TViewModel2 extends ObservableObject> extends StatefulWidget {
...
class _BindViewModel2State<TViewModel1 extends ObservableObject, TViewModel2 extends ObservableObject>
...
/// )
/// ```
class BindViewModel3<TViewModel1 extends ObservableObject, TViewModel2 extends ObservableObject, TViewModel3 extends ObservableObject>
...
class _BindViewModel3State<TViewModel1 extends ObservableObject, TViewModel2 extends ObservableObject, TViewModel3 extends ObservableObject>
...
/// )
/// ```
class BindViewModel4<TViewModel1 extends ObservableObject, TViewModel2 extends ObservableObject, TViewModel3 extends ObservableObject, TViewModel4 extends ObservableObject>
    extends StatefulWidget {
  /// The builder function that receives three resolved ViewModels.
  final Widget Function(
    BuildContext context,
  ...
  @override
  State<BindViewModel4<TViewModel1, TViewModel2, TViewModel3, TViewModel4>> createState() =>
      _BindViewModel4State<TViewModel1, TViewModel2, TViewModel3, TViewModel4>();
}

class _BindViewModel4State<TViewModel1 extends ObservableObject, TViewModel2 extends ObservableObject, TViewModel3 extends ObservableObject, TViewModel4 extends ObservableObject>
    extends State<BindViewModel4<TViewModel1, TViewModel2, TViewModel3, TViewModel4>> {
  final List<VoidCallback> _disposers = [];
  final Set<ObservableNode> _currentNodes = {};
