...
/// A widget that automatically subscribes to all [ObservableNode] instances
...
/// Unlike the standard [Bind] widget which requires explicit selectors, [BindObserver]
/// automatically tracks which properties and commands are accessed and only rebuilds
...
/// ## When to Use
/// 
/// - **Multiple properties**: Access several properties from the same ViewModel
...
/// ## How It Works
/// 
/// During the build phase, [BindObserver] creates a tracking session via
...
class BindObserver<TViewModel extends ObservableObject> extends StatefulWidget {
  ...
  @override
  State<BindObserver<TViewModel>> createState() =>
      _BindObserverState<TViewModel>();
}

class _BindObserverState<TViewModel extends ObservableObject> extends State<BindObserver<TViewModel>> {
...
/// 
/// This is the two-ViewModel variant of [BindObserver]. Use when you need to
/// observe properties from multiple ViewModels simultaneously.
/// 
/// Example:
/// ```dart
/// BindObserver2<UserViewModel, SettingsViewModel>(
...
/// )
/// ```
class BindObserver2<TViewModel1 extends ObservableObject, TViewModel2 extends ObservableObject> extends StatefulWidget {
  ...
  @override
  State<BindObserver2<TViewModel1, TViewModel2>> createState() =>
      _BindObserver2State<TViewModel1, TViewModel2>();
}

class _BindObserver2State<TViewModel1 extends ObservableObject, TViewModel2 extends ObservableObject>
    extends State<BindObserver2<TViewModel1, TViewModel2>> {
  final List<VoidCallback> _disposers = [];
  final Set<ObservableNode> _currentNodes = {};
...
/// 
/// This is the three-ViewModel variant of [BindObserver]. Use when you need to
/// observe properties from multiple ViewModels simultaneously.
/// 
/// Example:
/// ```dart
/// BindObserver3<UserViewModel, SettingsViewModel, DataViewModel>(
...
/// )
/// ```
class BindObserver3<TViewModel1 extends ObservableObject, TViewModel2 extends ObservableObject, TViewModel3 extends ObservableObject>
  ...
  @override
  State<BindObserver3<TViewModel1, TViewModel2, TViewModel3>> createState() =>
      _BindObserver3State<TViewModel1, TViewModel2, TViewModel3>();
}

class _BindObserver3State<TViewModel1 extends ObservableObject, TViewModel2 extends ObservableObject, TViewModel3 extends ObservableObject>
    extends State<BindObserver3<TViewModel1, TViewModel2, TViewModel3>> {
  final List<VoidCallback> _disposers = [];
  final Set<ObservableNode> _currentNodes = {};
