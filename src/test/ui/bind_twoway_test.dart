    ...
    testWidgets('should detect ObservableProperty and enable two-way binding', (tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: FairyScope(
            viewModel: (_) => vm,
            child: Bind.viewModel<TestViewModel, String>(
              selector: (vm) => vm.name,
    ...
    testWidgets('should work with nullable ObservableProperty', (tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: FairyScope(
            viewModel: (_) => vm,
            child: Bind.viewModel<NullableViewModel, String?>(
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: FairyScope(
            ...
            child: Column(
              children: [
                Bind.viewModel<TestViewModel, String>(
                  selector: (vm) => vm.name,
                  builder: (context, value, update) {
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: FairyScope(
              viewModel: (_) => vm,
              child: Bind.viewModel<BoolViewModel, bool>(
    ...
    testWidgets('should work with custom object ObservableProperty', (tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: FairyScope(
            viewModel: (_) => vm,
            child: Bind.viewModel<CustomObjectViewModel, User>(
              selector: (vm) => vm.user,
              builder: (context, value, update) {
                return Column(
                  children: [
