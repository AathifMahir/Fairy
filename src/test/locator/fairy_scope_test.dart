...
void main() {
  ...
  group('FairyScope widget', () {
    ...
    group('viewModel parameter', () {
      ...
      testWidgets('should create ViewModel only once per build', (tester) async {
        var createCount = 0;
        TestViewModel? vm;
        ...
        final secondVm = FairyScope.of(tester.element(find.byType(Builder)))!.get<TestViewModel>();
    ...
    group('viewModels parameter', () {
      testWidgets('should create and register ViewModels via factories', (tester) async {
        await tester.pumpWidget(
          FairyScope(
            viewModels: [
      ...
      testWidgets('should dispose created ViewModels by default', (tester) async {
        final vm1 = TestViewModel();
        final vm2 = AnotherViewModel();
      ...
      testWidgets('should register multiple ViewModels in order', (tester) async {
        await tester.pumpWidget(
          FairyScope(
            viewModels: [
              (locator) => TestViewModel(),
    ...
    group('integration scenarios', () {
      ...
      testWidgets('should throw assertion if both viewModel and viewModels are provided', (tester) async {
      ...
      testWidgets('should create new ViewModels on widget replacement', (tester) async {
        var createCount = 0;
  ...
  group('FairyScopeLocator', () {
    ...
    group('dependency resolution from FairyLocator', () {
      ...
      testWidgets('should inject multiple services from FairyLocator', (tester) async {
        ...
        await tester.pumpWidget(
          FairyScope(
            ...
            child: Builder(
              builder: (context) {
                final vm = FairyScope.of(context)!.get<ViewModelWithDependencies>();
      ...
      testWidgets('should throw error if service not registered', (tester) async {
        await tester.pumpWidget(
          FairyScope(
            viewModel: (locator) {
        ...
        expect(exception.toString(), contains('No dependency of type TestService'));
      });
    });
          ...
          FairyScope(
            ...
            child: FairyScope(
              viewModel: (locator) {
                ...
                return ViewModelWithDependencies(TestService(), AnotherService());
              },
              child: Builder(
                builder: (context) {
                  childVm = FairyScope.of(context)?.get<ViewModelWithDependencies>();
                  return const SizedBox();
                },
              ),
            ),
    ...
    group('dependency resolution from same scope (sequential)', () {
      testWidgets('should resolve ViewModels created earlier in same scope', (tester) async {
          ...
          FairyScope(
            viewModels: [
              ...
              (locator) {
                ...
                secondVm = ViewModelWithDependencies(TestService(), AnotherService());
                return secondVm!;
              },
            ],
            child: const SizedBox(),
      ...
      testWidgets('should support dependency chain in same scope', (tester) async {
        await tester.pumpWidget(
          FairyScope(
            viewModels: [
              (locator) => TestViewModel(),
            ...
            child: Builder(
              builder: (context) {
                ...
                expect(identical(complex.vm1, data.get<TestViewModel>()), isTrue);
      ...
      testWidgets('should throw if trying to get ViewModel created later', (tester) async {
        await tester.pumpWidget(
          FairyScope(
            viewModels: [
              (locator) {
        ...
        final exception = tester.takeException();
        expect(exception, isA<StateError>());
        expect(exception.toString(), contains('No dependency of type AnotherViewModel'));
      });
    });

    group('hybrid resolution (scope + locator)', () {
      testWidgets('should resolve from both parent scope and FairyLocator', (tester) async {
        final service = TestService();
        FairyLocator.instance.registerSingleton<TestService>(service);
        ...
        await tester.pumpWidget(
          FairyScope(
            ...
            child: FairyScope(
              ...
              child: Builder(
                builder: (context) {
                  final vm = FairyScope.of(context)!.get<ViewModelWithMixedDependencies>();
      ...
      testWidgets('should prefer parent scope over FairyLocator for same type', (tester) async {
    ...
    group('locator lifecycle and safety', () {
      testWidgets('should invalidate locator after initialization', (tester) async {
      ...
      testWidgets('should show helpful error when used outside init', (tester) async {
        FairyScopeLocator? capturedLocator;
      ...
      testWidgets('should not allow storing locator in ViewModel', (tester) async {
        await tester.pumpWidget(
          FairyScope(
    ...
    group('error handling', () {
      testWidgets('should provide clear error for missing dependency', (tester) async {
        await tester.pumpWidget(
          FairyScope(
            viewModel: (locator) {
        ...
        expect(exception.toString(), contains('FairyScope hierarchy or FairyLocator'));
      });
    ...
    group('complex scenarios', () {
      testWidgets('should handle deep nesting with mixed dependencies', (tester) async {
        final service = TestService();
        FairyLocator.instance.registerSingleton<TestService>(service);
      ...
      testWidgets('should resolve correctly with same-type VMs in different scopes', (tester) async {
